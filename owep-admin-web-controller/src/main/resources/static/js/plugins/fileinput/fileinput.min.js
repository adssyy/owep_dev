...
!function (e) {
    ...
    t = {
        ...
        cspBuffer: {
            ...
            apply: function (t) {
                ...
                a.find("[" + i.CSP_ATTRIB + "]").each(function (t, a) {
                    var r = e(a), n = r.attr(i.CSP_ATTRIB), o = i.domElementsStyles[n], l = i.domElementEvents[n];
        ...
        constructor: i, _cleanup: function () {
            ...
            var i = this, a = i.taskManager = {
                pool: {}, addPool: function (e) {
                    ...
                    a.id = t, a.deferred = e.Deferred(), a.logic = i, a.context = null, a.run = function () {
                        ...
                        return t.unshift(a.deferred), i.apply(a.context, t), a.deferred
            ...
            if (i.enableResumableUpload) {
                ...
                i.resumableManager = {
                    init: function (e, t, a) {
                        ...
                        var e, t, a = i.taskManager, r = i.resumableManager, n = r.chunkCount;
                        ...
                        var a = i.taskManager, n = i.resumableManager, o = a.getPool(n.id);
                        o.addTask(o.size() + 1, function (e) {
                            var t, a = n.stack.shift();
                            t = a[0], n.chunksProcessed[n.id] && n.chunksProcessed[n.id][t] ? i._log(r.chunkQueueError, {index: t}) : n.sendAjax(t, a[1], e)
                        }), n.stack.push([e, t])
                    }, sendAjax: function (e, a, n) {
                        var o, l = i.fileManager, s = i.resumableManager, d = i.resumableUploadOptions, c = s.chunkSize,
                            u = s.id, p = s.file, f = s.$thumb, g = s.$btnDelete;
                        if (!s.chunksProcessed[u] || !s.chunksProcessed[u][e]) {
                            ...
                            m = new FormData, o = l.stack[u], i._setUploadData(m, {
                                ...
                                var c = i.uploadParamNames, p = c.chunkIndex || "chunkIndex",
                                    f = i.resumableUploadOptions, g = [u, e, a, l, s, h];
            ...
            var i, a, r, n, o, l, s, d, c, u, p, f, g, m, h, v, w, b, _, C, y, x, T, P, k, E, F, S, I, A, D, z, M, j, U,
                $, R, O, B, L, N, Z = this;
            ...
            var n, o, l, s, d, c, u, p, f, g, m, h, v, w = this, b = w.fileManager, _ = b.count(), C = new FormData,
                ...
                T = w.ajaxOperations.uploadThumb, P = b.getFile(a), k = {id: y, index: i, fileId: a},
            ...
            }, C.append(w.uploadFileAttr, P.file, E), w._setUploadData(C, {fileId: a}), w._ajaxSubmit(p, g, m, h, C, a, i)))
            ...
            var h, v, w, b = this, _ = b.slug(r), C = "", y = "",
                ...
                P = _, k = "type-default", E = u || b._renderFileFooter(i, _, d, "auto", s), F = b.preferIconicPreview,
                S = b.preferIconicZoomPreview, I = F ? "other" : i;
            ...
            }, p = p || o.slice(o.lastIndexOf("-") + 1), b.fileActionSettings.showZoom && (C = w(S ? "other" : i, m ? m : a, !0, "kv-zoom-thumb")), C = "\n" + b._getLayoutTemplate("zoomCache").replace("{zoomContent}", C), "function" == typeof b.sanitizeZoomCache && (C = b.sanitizeZoomCache(C)), h = w(F ? "other" : i, a, !1, "kv-preview-thumb"), h.setTokens({zoomCache: C})
            ...
            if (o.showPreview || l && l.length) {
                ...
                if (o.enableResumableUpload) {
                    var m, h = n.loaded, v = u.getUploadedSize(), w = u.file.size;
            ...
            var o, l, s, d, c, u, p, f, g, m, h = this, v = e(a.img)[0], w = v.naturalWidth, b = v.naturalHeight, _ = 1,
                ...
                P = h.imageCanvasContext, k = a.typ, E = a.pid, F = a.ind, S = a.thumb, I = a.exifObj;
            if (c = function (e, t, i) {
            ...
            return t.cspBuffer.apply(a), a.insertBefore(e.$element).attr(i),
                e._initBrowse(a), e.theme && a.addClass("theme-" + e.theme), a
            ...
            var a, r = this, n = r.reader, o = r.$previewContainer, l = r.$previewStatus, s = r.msgLoading,
                ...
                v = function (t, n, o, l, s) {
                    ...
                    removeThumb || r._previewDefault(n, !0), d = r._getFrame(o, !0), r.isAjaxUpload ? setTimeout(function () {
                        a(l + 1)
            ...
            r.fileManager.clearImages(), e.each(i, function (e, t) {
                ...
                r.lock(!0);
                var y, x, T, P, k, E, F, S, I, A, D, z, M, j, U = i[w], $ = c + "-" + r._getFileId(U), R = p.text,
                    O = p.image, B = p.html, L = r._getFileName(U, ""), N = (U && U.size || 0) / 1e3, Z = "",
                    H = t.createObjectURL(U), W = 0, q = "", V = !1, K = 0, G = function () {
                ...
                if (U) {
                    ...
                    if (t.isEmpty(m) || (Z = new RegExp("\\.(" + m.join("|") + ")$", "i")), y = N.toFixed(2), r.isAjaxUpload && C.exists(S) || r._getFrame($, !0).length) {
                        ...
                        return T = r.msgDuplicateFile.setTokens({
                            name: L,
                            size: y
                        }), void (r.isAjaxUpload ? (r.duplicateErrors.push(T), r.isDuplicateError = !0, r._raise("fileduplicateerror", [U, S, L, y, $, w]), a(w + 1), r._updateFileDetails(u)) : (r._showError(T, Y), r.unlock(), u = 0, r._clearFileInput(), r.reset(), r._updateFileDetails(u)))
                    }
                    ...
                    D = R(U.type, L), z = B(U.type, L), M = O(U.type, L), l.html(s.replace("{index}", w + 1).replace("{files}", u)), o.addClass("file-thumb-loading"), n.onerror = function (e) {
                        ...
                        var a, s, d, c, u, f, g = [], m = function (e) {
                        ...
                        if (s = {name: L, type: U.type}, e.each(p, function (e, t) {
                        ...
                        if (e.lengthComputable) {
                            ...
                            T = d.setTokens({index: w + 1, files: u, percent: i, name: L}), setTimeout(function () {
                                V || l.html(T)
                            }, r.processDelay)
                        }
